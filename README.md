...
- medical notes matter and should be visible quickly; this is crucial for the trainer's as they design their classes intensity accordingly
...
- trainers need exportable summaries of their batches at the end of each month (for admin related work of the studio)

## demo

If you want to test it out yourself, you can do so using a demo account!

- **Email:** `demo@ticksy.app`
- **Password:** `demo1234`


(ps: now i need to somehow build something to fix my mom's chai addiction :P)
