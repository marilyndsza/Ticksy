...
import { isUsingLocalSupabase } from '../lib/supabase'
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-ticksy-pink flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <Sparkle className="absolute bottom-24 right-12 w-8 h-8 text-ticksy-hotpink animate-pulse" />
      <Sparkle className="absolute bottom-32 right-20 w-5 h-5 text-ticksy-hotpink animate-pulse delay-200" />
      ...
      <div className="w-full max-w-sm z-10">
        <h1
          ...
          className="font-heading text-4xl font-bold text-[#0D3CA4] text-center mb-8"
        >
          Login
        </h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {error && (
            <p data-testid="login-error" className="text-red-600 text-sm font-body text-center">
              {error}
            </p>
          )}
          ...
          <p className="text-center font-body text-ticksy-navy/70 text-sm">
            ...
            <Link to="/signup" data-testid="login-signup-link" className="font-bold text-ticksy-navy underline">
              Sign Up
            </Link>
          </p>
